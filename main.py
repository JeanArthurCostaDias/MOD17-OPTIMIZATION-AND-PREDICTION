...
study_tst = run_optuna_study(objective_TSTPlus,sampler=optuna.samplers.TPESampler(n_startup_trials=250,seed=1),n_trials=1000,gc_after_trial=True,direction="minimize",show_plots=False)
