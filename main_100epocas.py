...
def objective_TSTPlus(trial):
    ...
    with open("./optuna_tests/TSTPlus2/{}.pickle".format(trial.number), "wb") as fout:
...
print(f""" Acesse a pasta optuna_tests/TSTPlus2/{study_tst.best_trial.number}.pickle e coloque o modelo no github """)
